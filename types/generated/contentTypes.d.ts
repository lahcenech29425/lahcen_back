...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    biography_content: Schema.Attribute.Text;
    birth_date: Schema.Attribute.Date;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    death_date: Schema.Attribute.Date;
    dua_content: Schema.Attribute.Text;
    dua_title: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sadaqah_introduction: Schema.Attribute.Text;
    section_title: Schema.Attribute.String;
    social_media: Schema.Attribute.Component<'global.social-link', true>;
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    contact: Schema.Attribute.Component<'global.contact-info', true>;
    ...
    menu: Schema.Attribute.Component<'elements.menu', true>;
    publishedAt: Schema.Attribute.DateTime;
    showGoToTop: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
...
export interface ApiHadithImageHadithImage extends Struct.CollectionTypeSchema {
  collectionName: 'hadith_images';
  info: {
    displayName: 'hadith_image';
    pluralName: 'hadith-images';
    singularName: 'hadith-image';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    orderItems: Schema.Attribute.Component<'orders.order-item', true>;
    phone: Schema.Attribute.BigInteger & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    shipping_address: Schema.Attribute.Component<'elements.address', false>;
...
export interface ApiPromotionPromotion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    isAutomatic: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::promotion.promotion'
    > &
      Schema.Attribute.Private;
    minimumOrder: Schema.Attribute.Integer;
...
export interface ApiQuranImageQuranImage extends Struct.CollectionTypeSchema {
  collectionName: 'quran_images';
  info: {
    displayName: 'quran_image';
    pluralName: 'quran-images';
    singularName: 'quran-image';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSiteConfigSiteConfig extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    currency: Schema.Attribute.Enumeration<['MAD', 'EUR', 'USD']>;
